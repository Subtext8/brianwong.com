...
tags:
  - wiki
  - comparison
description: "Synthesis comparing Karpathy's Vibe Coding (democratizing) vs Agentic Engineering (professional agent coordination)."
draft: false
---
...
| **Quality Bar**     | Exploratory/casual (may have vulns)      | Professional: No vulns, secure, robust           |
| **User Role**       | "Vibe" prompting iteratively             | Design fundamentals, taste/judgment; agents as interns |
| **Examples**        | Infinity side projects post-Dec 2025     | Big projects + agent attack sims for hiring      |
| **Quote**           | "Never felt more behind... I was vibe coding."$[^3$] | "Preserving the quality bar... coordinate agents."$[^3$] |
