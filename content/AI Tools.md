...
[Quartz](https://quartz.jzhao.xyz/) - a markdown to HTML generator. This is how this website is built and maintained.All done with it. Obsidian is what I use every day, so naturally, using Quartz to publish my thoughts is the most efficient way to keep content fresh and useful. 
